...
// Fondo animado con WebGL2 (shader de gradiente + ruido) — portado del
// componente de referencia (originalmente TSX/shadcn) a JSX plano, sin tipos,
// para que encaje con el resto del proyecto (ver nota en SpotlightButton.jsx:
// no hay Tailwind/TS/shadcn acá). Se monta una sola vez, fijo detrás de toda
// la página (ver App.jsx), reemplazando los fondos blancos por un degradé de
// marca (violeta -> cian sobre navy) en movimiento lento y sutil.
